...
test('class roster identity round-trips class, number, and normalized name', () => {
  ...
  assert.equal(classNumberFromId('s-0123456789ab-c8'), 8)
  assert.equal(classNumberFromId('s-0123456789ab-c30'), 30)
  assert.equal(classNumberFromId('s-0123456789ab-c31'), 0)
  assert.equal(classNumberFromId('s-not-a-digest-c8'), 0)
