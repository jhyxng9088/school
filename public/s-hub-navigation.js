(() => {
  ...
  function deliver(route) {
    ...
    // Navigation can be requested before React mounts (for example from a
    // notification tap). Keep the newest semantic route and hand it directly
    // to the React owner when it registers instead of synthesizing DOM clicks.
    pendingRoute = route
    return true
  }
