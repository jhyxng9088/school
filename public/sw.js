const CACHE_NAME = 'school-shell-v18'
const APP_SHELL = ['./', './manifest.webmanifest', './icon.svg', './school-sheet.css', './school-refinements.css', './school-sheet.js', './school-timetable-motion.js']
