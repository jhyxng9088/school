const CACHE_NAME = 'school-shell-v20'
const APP_SHELL = ['./', './manifest.webmanifest', './icon.svg', './school-sheet.css', './school-refinements.css', './stage3-polish.css', './school-sheet.js', './school-timetable-motion.js']
