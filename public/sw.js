const CACHE_NAME = 'school-shell-v17'
const APP_SHELL = ['./', './manifest.webmanifest', './icon.svg', './school-sheet.css', './school-refinements.css', './school-meal.css', './school-sheet.js', './school-timetable-motion.js', './school-meal.js']
