...
test('AI compose entry cascades through visible blocks instead of moving as one stage', () => {
  ...
  assert.match(css, /\.s-hub-ai-page-hero \{ animation-delay: 0ms; \}/)
  assert.match(css, /capability:nth-child\(1\) \{ animation-delay: 55ms; \}/)
  assert.match(css, /capability:nth-child\(2\) \{ animation-delay: 110ms; \}/)
  assert.match(css, /capability:nth-child\(3\) \{ animation-delay: 165ms; \}/)
  assert.match(css, /quick:nth-child\(1\) \{ animation-delay: 260ms; \}/)
  assert.match(css, /quick:nth-child\(4\) \{ animation-delay: 380ms; \}/)
  assert.match(css, /context-item:nth-child\(1\) \{ animation-delay: 480ms; \}/)
  assert.match(css, /context-item:nth-child\(4\) \{ animation-delay: 600ms; \}/)
  assert.match(css, /> \.s-hub-ai-content \{ animation-delay: 660ms; \}/)
})
