...
test('preview AI is promoted to a page without replacing its existing AI feature logic', () => {
  const hotfix = text('src/preview-v2-hotfix.js')
  const css = text('src/preview-v2-hotfix.css')
  assert.match(hotfix, /\.s-hub-ai-sheet/)
  assert.match(hotfix, /preview-v2-ai-page/)
  assert.match(hotfix, /unified-sheet-close/)
  assert.match(css, /unified-school-sheet\.preview-v2-ai-page/)
  assert.match(css, /height: 100dvh/)
  assert.match(css, /preview-v2-ai-backdrop/)
})
