...
test('server verifies Firebase identity while OpenRouter provider auth stays server-side', () => {
...
test('service worker cache advances for unified S-Hub AI UX', () => {
  assert.match(read('public/sw.js'), /const CACHE_NAME = 'school-shell-v168-class-scene-isolation'/)
})
